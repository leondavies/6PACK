...
import { Apple, ArrowLeft, Info, Target, TrendingUp, Activity } from "lucide-react";
      ...
      <div className="relative bg-gradient-to-r from-green-600 to-green-700 text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl leading-relaxed">
            Calculate your daily macronutrient needs for optimal nutrition and results
          </p>
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-green-700">For {goals[goal].label.toLowerCase()}</p>
                        </div>
                  ...
                  <ul className="space-y-3">
                    {recommendations.map((rec, index) => (
                      <li key={index} className="flex items-start">
                        <Info className="text-green-500 mr-2 mt-0.5 flex-shrink-0" size={16} />
