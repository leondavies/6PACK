...
export default function ArticlesPage() {
  ...
  return (
    <>
      <SEO
        title="Expert Fitness Articles & Guides | 6Pack NZ - Science-Backed Training Content"
        description="Discover expert-written fitness articles covering muscle building, weight loss, nutrition, and training strategies. Science-backed content from New Zealand's top fitness professionals. Free access to premium workout guides and health tips."
        keywords={[
        ...
        image="https://images.unsplash.com/photo-1434494878577-86c23bcb06b9?w=1200&h=630&fit=crop&fm=webp&q=85"
        url="/articles"
        breadcrumbs={breadcrumbs}
        structuredData={{
          type: 'CollectionPage',
          data: {
            name: '6Pack NZ Fitness Articles',
            description: 'Comprehensive collection of expert fitness articles and training guides',
      ...
      <div className="relative bg-gradient-to-r from-gray-900 to-gray-700 text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1434494878577-86c23bcb06b9?w=1600&h=900&fit=crop&fm=webp&q=85"
