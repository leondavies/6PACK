...
export const metadata = {
  title: 'Complete Workout Programs NZ | Home Fitness Routines | 6Pack',
  description: 'Complete workout programs for New Zealanders. Build muscle at home with our chest, leg, and core workouts. Expert fitness routines for all levels - no gym required!',
  keywords: 'workout programs NZ, home workouts New Zealand, fitness routines, chest workout, leg workout, core workout, bodyweight exercises, home gym NZ',
  openGraph: {
    title: 'Complete Workout Programs | Home Fitness Routines',
    description: 'Transform your body with our complete workout programs. Expert fitness routines for chest, legs, and core - all levels welcome.',
    images: [
      {
        url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&h=600&fit=crop&fm=webp&q=85',
        width: 1200,
        height: 600,
  ...
  twitter: {
    ...
    title: 'Complete Workout Programs | 6Pack NZ',
    description: 'Transform your body with our complete workout programs for all fitness levels.',
