                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                          <div className="bg-emerald-50 rounded-lg p-3 text-center">
                            <div className="text-emerald-600 font-semibold">{exercise.sets}</div>
                            <div className="text-sm text-emerald-800">Sets</div>
                          </div>
                          <div className="bg-teal-50 rounded-lg p-3 text-center">
                            <div className="text-teal-600 font-semibold">{exercise.reps}</div>
                            <div className="text-sm text-teal-800">Reps/Time</div>
                          </div>
                          <div className="bg-cyan-50 rounded-lg p-3 text-center">
                            <div className="text-cyan-600 font-semibold">{exercise.rest}</div>
                            <div className="text-sm text-cyan-800">Rest</div>
                          </div>
                        </div>
